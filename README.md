...
##Personal Note:
Because my Python is Python3, Commands were the followings:
1. alias python="/usr/bin/python2.7"
2. python dbClean.py -u "localhost" -p 3000
3. python dbFill.py -u "localhost" -p 3000 -n 20 -t 100
